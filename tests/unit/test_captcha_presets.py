...
from discord_webapi.captcha.checks import PredicateCheck
from discord_webapi.captcha.presets import build_cloudflare_style_guard
...
async def test_bind_trust_to_ip_defaults_to_true() -> None:
    """The specific "IP değişme sıklığı" behavior this preset was built
    for -- unlike AdaptiveCaptchaGate's own default of False."""
    guard = build_cloudflare_style_guard(InProcessTransport(), verify_url=_verify_url)
