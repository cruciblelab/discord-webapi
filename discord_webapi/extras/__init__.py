...
- One self-contained file per command/listener — no package-level registry,
  ...
  discord_webapi.extras` on its own registers nothing.
...
- "Full-featured" over "toy": e.g. `extras.ban` covers role-hierarchy
...
See `discord_webapi/extras/README.md` for the full writeup, including
