...
of `discord_webapi.captcha` -- this is not wired into
`DiscordWebAPI.install()`, and using it never precludes writing your own
frontend against the raw gate endpoints instead (or alongside it, for a
different page).
...
DEFAULT_WIDGET_MOUNT_PATH = "/static/discord-webapi-captcha-widget.js"
