...
as the rest of `discord_webapi.builtins`.
...
persistent strike count -- see `builtins.warn` for that. Wire
...
from discord_webapi.builtins.automod import (
    banned_words,
    caps_spam,
    emoji_spam,
    invite_filter,
...
from discord_webapi.builtins.automod.exemptions import is_exempt
...
def setup(
    ...
    *,
    ...
    -- e.g. to bump a `builtins.warn` count, without this module needing
    to import `warn.py` itself.

    See `builtins.automod.exemptions.is_exempt` for who's skipped
